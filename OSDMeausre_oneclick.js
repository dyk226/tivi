...
class OSDMeasure {
    ...
    constructor(viewer, options = {}) {
        ...
        // add our custom handler for measurements org: canvas-double-click
    ...
    if (this.isMeasuringMode) {
        this.viewer.addHandler('canvas-click', this.handleMeasureClick);
    } else {
        this.viewer.removeHandler('canvas-click', this.handleMeasureClick);
    }
}
